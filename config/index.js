export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wxed435418a85d5b12",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "56c25696f2a1b87812ad13f85d3ab2fc",
   ...
   *    id: "oy5Iy6ZnTudY4aL6epBAUg_EhMn4",
   *    // 你想对他发送的模板消息的模板ID
   *    useTemplateId: "D-FmOb0MZKws3le4QNFPksQUsQSnE6EYI0ysmbvm2dA",
  ...
  USERS: [
    {
      ...
      name: "老婆",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oy5Iy6bo-qXJlHgh-IK0q_6nH5Ls",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "D-FmOb0MZKws3le4QNFPksQUsQSnE6EYI0ysmbvm2dA",
      // 所在省份
      province: "青海",
